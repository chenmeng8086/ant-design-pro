    ...
    render () {
        return (
            <Card>
                ...
                <Row>
                    <Col span={12}><SelectTag tagList={this.props.quotaTypes} name={'指标类型'}></SelectTag></Col>
                    <Col span={12}><SelectTag tagList={this.props.statusList} name={'状态'}></SelectTag></Col>
                </Row>

                <Divider />

                <Row align="middle">
                    <Col span={12}><SelectTag tagList={this.props.dataSource} name={'数据源'}></SelectTag></Col>
                    <Col span={12}>
                        <Row>
                            <Col className={style.user_name}>负责人：</Col>
                            <Col span={12}>
                                <Select defaultValue="张三" style={{ width: 120 }} size="small">
                                    {
